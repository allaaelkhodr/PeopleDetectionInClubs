...
def face_detection(img, img_name):
    ...
    face_cascade = cv2.CascadeClassifier('C:/Users/ael-k/Anaconda3/Lib/site-packages/cv2/data/haarcascade_frontalface_default.xml')
    eye_cascade = cv2.CascadeClassifier('C:/Users/ael-k/Anaconda3/Lib/site-packages/cv2/data/haarcascade_eye.xml')
    fullbody_cascade = cv2.CascadeClassifier('C:/Users/ael-k/Anaconda3/Lib/site-packages/cv2/data/haarcascade_fullbody.xml')
    upperbody_cascade = cv2.CascadeClassifier('C:/Users/ael-k/Anaconda3/Lib/site-packages/cv2/data/haarcascade_upperbody.xml')
    lowerbody_cascade = cv2.CascadeClassifier('C:/Users/ael-k/Anaconda3/Lib/site-packages/cv2/data/haarcascade_lowerbody.xml')
    leftear_cascade = cv2.CascadeClassifier('C:/Users/ael-k/Anaconda3/Lib/site-packages/cv2/data/haarcascade_mcs_leftear.xml')
    rightear_cascade = cv2.CascadeClassifier('C:/Users/ael-k/Anaconda3/Lib/site-packages/cv2/data/haarcascade_mcs_rightear.xml')
